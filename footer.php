    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="footer-item">
                    ...
                    <p class="small mb-0">Email: <a href="mailto:info@esilib.com" class="text-light">info@esilib.com</a></p>
                    <p class="small">Telp: <a href="tel:+62222000000" class="text-light">+62 22 2000 000</a></p>
                </div>
            </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-6 text-center text-md-start mb-2 mb-md-0">
                <p class="mb-0 small">© 2025 E-Silib. All Rights Reserved.</p>
            </div>
            <div class="col-md-6 text-center text-md-end">
                <a href="#" class="text-light me-3"><i class="icon icon-facebook"></i></a>
                <a href="#" class="text-light me-3"><i class="icon icon-twitter"></i></a>
                <a href="#" class="text-light me-3"><i class="icon icon-youtube-play"></i></a>
                <a href="#" class="text-light"><i class="icon icon-instagram"></i></a>
            </div>
        </div>
    </div>
</footer>
